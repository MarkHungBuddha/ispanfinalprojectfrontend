  ...
  <v-app>
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="12">
          <v-file-input multiple show-size accept="image/*" v-model="productImages" :counter="10"
            label="上傳商品圖片 (最多10張)"></v-file-input>
        </v-col>
        ...
        <v-col cols="12" class="text-right">
          <v-btn color="primary" @click="uploadProduct">上傳商品</v-btn>
        </v-col>
      </v-row>
    </v-container>
  </v-app>
