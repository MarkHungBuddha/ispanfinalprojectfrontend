...
<template>
  <v-app>
    ...
    <v-container fluid style="width:90%">
      <v-row class="my-4" id="title">
        <v-col cols="1"></v-col>
        <v-col cols="5" class="font-weight-bold">商品</v-col>
        <v-col cols="" class="font-weight-bold">數量</v-col>
        <v-col cols="2" class="font-weight-bold">價格</v-col>
        <v-col cols="2" class="text-center font-weight-bold">操作</v-col>
      </v-row>

      <v-divider></v-divider>


      <v-row v-for="(item, index) in itemList" :key="item.id" class="py-2 item-row align-center" id="cont">
        <v-card class="pa-2 mb-2 w-100 condensed-card">
          <v-col cols="1" style="float:left">
            <v-checkbox v-model="item.checked"></v-checkbox>
          </v-col>
          <v-col cols="5" class="d-flex align-center" style="float:left">
            <v-img :src="item.imgUrl" width="100" height="100" contain></v-img>
            <span class="font-weight-medium">{{ item.itemName }}</span>
          </v-col>

          <v-col cols="2" class="d-flex align-center" style="float:left">
          ...
          <v-col cols="2" class="font-weight-bold" style="float:left;text-align: center !important;">
          ...
          <v-col cols="2" class="text-center" style="float:left">
